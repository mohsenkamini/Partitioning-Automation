...
- You cannot make **swap partitions** that are based on a **file** rather than a disk partitions with this document. [more on that](https://docs.alfresco.com/3.4/tasks/swap-space-lin.html)
